          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                percentage: "24%",
                detail:
                  "1足6,578円〜という価格に対して「高い」と感じる方もいます。ただし、4足セットなら1足あたり4,530円、6足セットなら4,026円になるほか（公式サイトにて2026年7月確認）、毎月ジムに通う（月額8,000〜15,000円）ことと比較すると、コストパフォーマンスは高いと言えます。また、1足の使用目安は3〜6ヶ月のため、月換算では1,000〜2,200円程度です。",
                color: "text-[#c9a76c]",
              },
              {
                rank: "3位",
                ...
                percentage: "16%",
                detail:
                  "靴のサイズとピットソールのサイズが合わず、靴の中で動いてしまう、窮屈に感じるなどの理由でやめた方もいます。ピットソールはXS（21〜22.5cm）・S（23〜24.5cm）・M（25〜26cm）・L（26.5〜27.5cm）・XL（28〜29cm ※ブラック・ピンクのみ）の5サイズ展開で、自分の靴に合わせてカットして調整が可能です。サイズ選びのコツは後述します。",
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed mt-8">
            <p>
              このように、ピットソールは科学的根拠と実績において他のダイエットインソールとは一線を画しています。ただし、価格帯は3製品とも単品6,000円台と近いため、設計思想や対応サイズも含めて選ぶことが大切です。
            </p>
            <p>
              整体師監修の設計や抗菌防臭を重視する方には、スリムアップインソール（単品6,980円・3足+1足セットなら1足あたり4,480円、公式サイトにて2026年7月確認）という選択肢もあります。
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              },
              {
                num: "05",
                title: "複数の靴で使い回す",
                desc: "スニーカー、ビジネスシューズ、ウォーキングシューズなど、日常的に履く靴すべてにピットソールを入れるのが理想です。4足・6足のまとめ買いセットならコストも抑えられ、どの靴を履いても常にアーチサポートを受けられます。",
              },
              {
                num: "06",
                title: "食事は現状維持を心がける",
