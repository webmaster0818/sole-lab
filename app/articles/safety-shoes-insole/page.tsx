...
const faqs = [{"q": "安全靴に入る薄いインソールはありますか？", "a": "はい、薄型でアーチサポートのあるインソールなら安全靴にも入ります。つま先の保護芯に干渉しないよう、必要なら元の中敷きを外して使いましょう。"}, {"q": "安全靴の足の疲れに効果はありますか？", "a": "硬い靴底と硬い床の衝撃を吸収し、アーチを支えることで足裏の疲れ・痛みを軽減する補助になります。"}, {"q": "どのくらいで交換すべきですか？", "a": "毎日長時間使う現場作業では、3〜6ヶ月が交換の目安です。クッションが薄くなったら効果低下のサインです。"}];
...
const points = [{"t": "保護芯に干渉しない薄型", "b": "安全靴は中が狭いため、厚すぎるとつま先が窮屈に。薄型を選ぶか元の中敷きを外して入れましょう。"}, {"t": "衝撃吸収とアーチサポート", "b": "硬い床・硬い靴底の衝撃を吸収しつつ、アーチを支える設計で足裏の負担を軽減します。"}, {"t": "毎日使える耐久性", "b": "作業現場で毎日長時間使うため、へたりにくい耐久性のある素材を選びましょう。"}];
  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-lg md:text-2xl font-bold text-gray-900 border-l-4 border-[#0ea5e9] pl-3 mb-6">安全靴の選び方3つのポイント</h2>
          {points.map((p, i) => (
