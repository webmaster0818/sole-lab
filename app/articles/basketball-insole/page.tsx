...
const faqs = [{"q": "バスケでインソールを使うと足首の捻挫を予防できますか？", "a": "後足部を安定させるインソールは足のブレを抑え、捻挫予防の補助になります。あわせて足首の筋力・バランストレーニングを行うとより効果的です。"}, {"q": "バッシュの元の中敷きは外すべきですか？", "a": "フィットと効果を保つため、元の中敷きを外してインソールと入れ替えるのがおすすめです。厚みが合わない場合は調整しましょう。"}, {"q": "ジャンプ力に影響しますか？", "a": "アーチを支えると踏み込みの力が伝わりやすくなり、安定した着地で次の動作に移りやすくなります。過度な期待は禁物ですが、安定感の向上が見込めます。"}];
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">インソールで着地衝撃を吸収し、かかとを安定させて足の過度なブレを抑えると、ケガのリスクを減らしながら踏ん張りやすくなります。アーチサポートはダッシュ時の力の伝達も助けます。</p>
        </section>
        ...
        <section className="mb-12">
          <h2 className="text-lg md:text-2xl font-bold text-gray-900 border-l-4 border-[#0ea5e9] pl-3 mb-6">バッシュでの使い方</h2>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">バスケットシューズに入れる際は、元の中敷きを外して入れ替えるとフィットが保てます。足首の不安定さが気になる場合は、足首サポーターやバランストレーニングも併用しましょう。</p>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">激しい競技で消耗が早いため、クッションがへたったら早めに交換すると衝撃吸収効果を保てます。</p>
        </section>
