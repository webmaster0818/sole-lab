...
const faqs = [{"q": "ドラッグストアにダイエットインソールはありますか？", "a": "痛み・疲れ向けの汎用品が中心で、本格的なダイエットインソールの取り扱いは限られます。専用品は公式通販やAmazon・楽天が中心です。"}, {"q": "薬局のインソールはどんな人に向きますか？", "a": "足の痛みや疲れ、外反母趾やかかとケアなど、症状対応をすぐ手軽に行いたい方に向いています。"}, {"q": "専用品との違いは何ですか？", "a": "目的が異なります。市販品は痛み・疲れ対策、ダイエットインソールは姿勢・歩行を整える設計です。"}, {"q": "市販品と専用品、どちらを選べばいいですか？", "a": "目的次第です。立ち仕事や歩行時の痛み・疲れをすぐ和らげたいなら手軽な市販の汎用品、姿勢や歩き方を整えてボディメイクを狙うなら専用設計の製品が向きます。両方を使い分ける人もいます。"}, {"q": "ドラッグストアのインソールの価格はどのくらいですか？", "a": "サイズ調整用の簡易タイプから、衝撃吸収・アーチサポート付きの機能タイプまで価格帯に幅があります。具体的な金額は商品や時期で変わるため、店頭の値札や各メーカーの公式サイトでご確認ください。"}];
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">店頭で見かけるインソールは、大きく分けて次のようなタイプがあります。靴のサイズ・フィット感を微調整する簡易タイプ、長時間の立ち仕事や歩行の衝撃をやわらげるクッション・低反発タイプ、土踏まずを支えるアーチサポートタイプ、消臭・抗菌や保温など機能特化タイプなどです。価格はタイプや素材によって幅があり、シンプルなものほど手頃、機能が増えるほど高くなる傾向があります。</p>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">選ぶ際は、まず使う靴のサイズに合っているか、カット調整が必要か、目的（痛み対策か・疲れ対策か・サイズ調整か）に合っているかを確認しましょう。具体的な商品名や価格は時期や店舗で変わるため、店頭の表示や各メーカーの公式サイトでの確認をおすすめします。</p>
        </section>
