...
const faqs = [{"q": "幅広の靴にもインソールは入りますか？", "a": "はい。元の中敷きと入れ替えるタイプなら、幅広の靴でも窮屈になりにくく使えます。前足部にゆとりのある設計を選びましょう。"}, {"q": "足の幅が広いのはなぜですか？", "a": "横アーチの低下による開張足が一因のことがあります。横アーチを支えるインソールは、広がりの進行を抑える補助になります。"}, {"q": "甲高でもインソールは使えますか？", "a": "薄型のインソールを選び、必要なら元の中敷きを外して厚みを調整すれば、甲高の方でも窮屈になりにくく使えます。"}];
...
const points = [{"t": "横アーチを支える中足骨パッド", "b": "開張足による足幅の広がりには、横アーチを支える中足骨パッド付きが効果的です。"}, {"t": "前足部にゆとりのある設計", "b": "幅広の足には、前足部が狭くならない設計が必須。元の中敷きと入れ替えて厚みを調整しましょう。"}, {"t": "縦アーチも支える総合サポート", "b": "横アーチに加え内側縦アーチも支えると足全体が安定します。3点支持の設計が理想です。"}];
  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-lg md:text-2xl font-bold text-gray-900 border-l-4 border-[#0ea5e9] pl-3 mb-6">幅広・3Eの靴の選び方3つのポイント</h2>
          {points.map((p, i) => (
