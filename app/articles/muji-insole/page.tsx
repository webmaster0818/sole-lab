...
const faqs = [{"q": "無印にダイエットインソールはありますか？", "a": "無印のインソールは日常の快適さ向けが中心で、ダイエット専用設計ではありません。ダイエット目的には専用品が向いています。"}, {"q": "無印のインソールはどんな人に向きますか？", "a": "シンプルで日常使いしやすいため、普段履きの靴を少し快適にしたい方に向いています。"}, {"q": "専用品との違いは何ですか？", "a": "目的が異なります。無印品は日常の快適さ重視、ダイエットインソールは姿勢・歩行を整えて使う筋肉を増やす設計です。"}, {"q": "無印の中敷きでダイエットインソールの代用はできますか？", "a": "クッション性や履き心地の調整には役立ちますが、ダイエット専用品のように姿勢・歩行を整える設計とは目的が異なるため、ボディメイクを狙う代用としては力不足です。日常の快適さ補強として使い分けるのが現実的です。"}, {"q": "無印にはどんな足まわりの商品がありますか？", "a": "中敷き（インソール）のほか、靴下やルームシューズなど足まわりの日用品を扱う傾向があります。取り扱いは時期・店舗で変わるため、最新の品揃え・価格は店舗または公式サイトでご確認ください。"}];
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">市販のインソールは、おおまかに用途で分かれます。選ぶときは次の3つの軸を意識すると迷いにくくなります。</p>
          <ul className="text-sm md:text-base text-gray-700 leading-relaxed mb-4 list-disc pl-5 space-y-2">
            <li><span className="font-bold">クッション・衝撃吸収タイプ</span>：立ち仕事や長時間歩行の疲れをやわらげたい人向け。普段履きの快適さを底上げしたいなら無印のようなシンプル系で十分なことが多いです。</li>
            <li><span className="font-bold">消臭・サラサラ系タイプ</span>：ムレやニオイが気になる人向け。素材で機能が変わるため、用途に合うものを選びます。</li>
            <li><span className="font-bold">アーチサポート・姿勢タイプ</span>：足裏のアーチを支えて姿勢や歩き方を整えたい人向け。ダイエットインソールはここに位置づけられ、設計の意図が日常向けとは異なります。</li>
          </ul>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">同じ「中敷き」でも狙いが違うため、ダイエットや姿勢ケアを重視するなら専用設計、日々の履き心地の調整ならシンプル系、と分けて考えると失敗しにくくなります。具体的な品揃え・素材・価格は時期や店舗で変わるため、購入前に店舗または公式サイトで確認するのが確実です。</p>
