...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "スリムアップインソールは公式サイトでS（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズから選ぶ選択式です（公式サイトにて2026年7月確認）。購入前に足の実寸を測り、対応範囲に合ったサイズを選びましょう。サイズが合わなかった場合の交換可否や条件は、公式サイトでご確認ください。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "予算に余裕があり、科学的根拠と実績を重視する方にはピットソール（6,578円〜）がおすすめです。スリムアップインソール（単品6,980円・3足+1足セットなら1足あたり4,480円、公式サイトにて2026年7月確認）は整体師監修の設計と抗菌防臭が特徴で、セット購入時のコスパに優れています。",
  },
  {
    question: "スリムアップインソールは男性でも使えますか？",
    answer:
      "スリムアップインソールの公式サイズ展開はS（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズで、最大26.5cmまで対応しています（公式サイトにて2026年7月確認）。足のサイズが26.5cm以内であれば男性でも使用できますが、26.5cmを超える方は最大29cmまで対応するピットソール（XLはブラック・ピンク限定）などを検討しましょう。",
  },
];
    ...
    <>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            <p>
              スリムアップインソールは、傾斜設計で歩行時の筋肉を自然に刺激するダイエットサポートインソールです。単品6,980円（税込）・3足+1足セットなら1足あたり4,480円で（公式サイトにて2026年7月確認）、ダイエットインソール入門として人気があります。
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            {[
              {
                title: "手頃な価格",
                desc: "3足+1足セット（17,920円）なら1足あたり4,480円（公式サイトにて2026年7月確認）。セット購入なら1足あたりの負担を抑えて始められます。",
              },
              {
                title: "傾斜設計",
              ...
              {
                title: "シンプルな2サイズ展開",
                desc: "S（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズで最大26.5cmまで対応（公式サイトにて2026年7月確認）。足の実寸に合わせて選ぶ選択式のため、サイズ選びに迷いにくいのが特徴です。",
              },
            ].map((item) => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="card mb-6">
                  ...
                  {[
                    {
                      size: "S",
                      cm: "23.0〜24.5cm",
                      target: "足の実寸が23.0〜24.5cmの方",
                      cut: "選択式",
                    },
                    {
                      size: "M",
                      cm: "25.0〜26.5cm",
                      target: "足の実寸が25.0〜26.5cmの方",
                      cut: "選択式",
                    },
                  ].map((row) => (
            ...
            <p className="text-xs text-gray-500 mt-4">
              ※ 公式サイトの表記に基づくS/Mの2サイズ展開です（公式サイトにて2026年7月確認）。はさみで切って合わせる方式ではなく、購入時にサイズを選ぶ選択式です。
            </p>
          </div>
          ...
          <div className="card bg-amber-50 border-[#c9a76c]">
            ...
            <div className="space-y-2 text-sm text-gray-600 leading-relaxed">
              <p>
                スリムアップインソールは公式サイトでS（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズから選ぶ選択式です（公式サイトにて2026年7月確認）。カットはつま先・サイド部分の微調整として公式が案内していますが、サイズ自体はS/Mからの選択式のため、購入前に足の実寸を正確に測ることが大切です。
              </p>
              <p>
                <strong>サイズの境目の方は要注意：</strong>実寸が24.5cmを超えて25.0cm未満の方は、SとMの対応範囲の境目にあたります。購入前に公式サイトのサイズ案内を確認し、迷う場合は問い合わせてから選びましょう。
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                num: "01",
                title: "足の実寸を正確に測る",
                desc: "スリムアップインソールはS（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズ選択式です（公式サイトにて2026年7月確認）。かかとからつま先までの実寸を測り、対応範囲に合うサイズを選びましょう。",
              },
              {
                num: "02",
                title: "公式の対応範囲を確認して選ぶ",
                desc: "公式のサイズ対応範囲はS＝23.0〜24.5cm、M＝25.0〜26.5cmです。カットはつま先・サイドの微調整用のため、対応範囲の境目で迷う場合は、公式サイトのサイズ案内を確認するか購入前に問い合わせるのが確実です。",
              },
              {
                num: "03",
                title: "使う靴の中敷きを確認する",
                desc: "元の中敷きが取り外せる靴であれば、取り外してからスリムアップインソールを入れましょう。元の中敷きの上に重ねると厚みが出すぎて靴がきつくなります。",
              },
              {
                num: "04",
                title: "複数の靴で使い分ける場合は入れ替えに注意",
                desc: "異なる靴で使い回す場合、靴ごとにインソールを用意するのが理想です。靴の形状によってフィット感が変わるため、セット購入で複数枚確保すれば、靴ごとに入れ替えの手間なく使えます。",
              },
            ].map((item) => (
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg p-4 border border-orange-200">
            <h4 className="font-bold text-orange-700 mb-2">サイズ選びの注意点</h4>
            <p className="text-sm text-gray-700 leading-relaxed">
              スリムアップインソールはS（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズ選択式です（公式サイトにて2026年7月確認）。カットはつま先・サイドの微調整用として公式が案内しています。購入前に足の実寸を測り、対応範囲に合うサイズを選びましょう。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            <p>
              スリムアップインソールは、S（23.0〜24.5cm）・M（25.0〜26.5cm）の2サイズ展開で最大26.5cmまで対応する、手頃な価格のダイエットインソールです（公式サイトにて2026年7月確認）。傾斜設計により歩行時の筋肉を自然に刺激し、日常の歩行を効率的なエクササイズに変えてくれます。
            </p>
            <p>
              サイズ選びでは「足の実寸を正確に測る」「公式の対応範囲に合わせてS/Mを選ぶ」の2つが基本ルールです。効果を最大化するためには、かかとからつま先への正しい歩行フォームを意識し、1日5,000歩以上歩くことが重要です。
            </p>
            <p>
