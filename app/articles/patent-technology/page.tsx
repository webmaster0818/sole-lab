...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "特許技術を搭載したインソールは、一般的なクッション系インソール（500〜1,000円程度）と比較するとやや高価です。ピットソールは6,578円〜、ランウェイキュアソールは6,980円〜、スリムアップインソールは6,980円〜となっています（いずれも公式サイトにて2026年7月確認）。ただし、独自の設計開発費や研究費が価格に反映されており、機能性と耐久性の面では費用対効果は高いと言えます。",
  },
];
          ...
          <div className="mt-10">
            ...
            <div className="card mt-6 border-l-4 border-l-[#34d399]">
              <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                ...
                特許技術こそ持ちませんが、整体師監修による実用的な設計（単品6,980円・3足+1足セットなら1足あたり4,480円、公式サイトにて2026年7月確認）で、気軽に試しやすい選択肢です。抗菌防臭機能の搭載も日常使用における実用性を高めています。
              </p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-700">
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-3 pr-4">6,980円〜</td>
                  <td className="py-3">6,980円〜</td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 font-medium text-gray-900">
                    おすすめの方
