...
const faqs = [{"q": "サンダルにインソールは入れられますか？", "a": "ストラップや甲を覆うタイプのサンダルなら、薄型インソールを敷いて使えます。固定されないビーチサンダルではずれやすいため、フィットするものを選びましょう。"}, {"q": "夏の前すべりは防げますか？", "a": "表面に滑り止めのあるインソールは、汗による足の前すべりを抑える助けになります。指への負担軽減にもつながります。"}, {"q": "サンダルでも足の疲れに効果はありますか？", "a": "平らで底の薄いサンダルこそ、アーチサポートのあるインソールで疲れを軽減しやすくなります。"}, {"q": "インソールを入れると見た目はどうなりますか？", "a": "薄型タイプなら甲やストラップに隠れ、目立ちにくくなります。足の色味に近いベージュや黒など、サンダルの色に合う色を選ぶとより自然です。サイズが大きい場合は外周をカットして、はみ出さないように調整しましょう。"}, {"q": "素足で（靴下なしで）使えますか？", "a": "サンダルは素足で履くことが多いため、表面が肌当たりのよい素材で、汗を吸う・滑りにくいインソールが快適です。素足だと汗や皮脂が付きやすいので、こまめに乾かし、必要に応じてお手入れすると衛生的に使えます。"}, {"q": "インソールは洗えますか？", "a": "お手入れ方法は製品の素材によって異なります。水洗い可のものは中性洗剤でやさしく手洗いし、陰干しでよく乾かします。洗濯機の使用や乾燥機・直射日光は変形・劣化の原因になることがあるため、各製品の表示に従ってください。"}];
...
const points = [{"t": "薄型で素足感を損なわない", "b": "サンダルは見た目と軽さが大切。薄くて目立ちにくく、アーチサポートのあるものを選びましょう。"}, {"t": "汗による滑りを防ぐ表面", "b": "夏は足裏が汗で滑りがち。グリップのある表面素材で前すべりを防ぎます。"}, {"t": "アーチサポートで疲れを軽減", "b": "平らなサンダルの弱点を補うため、土踏まずを支える設計が疲れ対策になります。"}, {"t": "通気性・吸湿性のある素材を選ぶ", "b": "サンダルは蒸れにくいのが利点。インソールも通気孔のあるものや吸湿性の高い素材を選ぶと、足裏の汗をためずムレ・ニオイを抑えられます。"}, {"t": "カットして合わせられるタイプが便利", "b": "サンダルは靴より底面の形が様々。フルサイズのインソールはハサミで外周をカットしてサイズや形を微調整できるタイプだと、はみ出さずきれいに収まります。前足部だけを支えるハーフタイプも、底面が小さいサンダル向けです。"}];
  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-lg md:text-2xl font-bold text-gray-900 border-l-4 border-[#0ea5e9] pl-3 mb-6">サンダルの選び方のポイント</h2>
          {points.map((p, i) => (
