...
const faqs = [{"q": "ダイエットインソールに偽物はありますか？", "a": "人気製品には模倣品や非正規品が出回ることがあります。見た目が似ていても素材・設計が異なり、機能や保証が得られない場合があります。"}, {"q": "偽物を避けるにはどうすれば？", "a": "メーカー公式サイトや正規販売店から購入するのが確実です。極端に安い出品やフリマの中古は避け、販売元と保証を確認しましょう。"}, {"q": "フリマの中古は買っても大丈夫？", "a": "衛生面のほか、正規品保証・返金保証の対象外になることがほとんどです。安全と効果を考えると正規の新品がおすすめです。"}];
...
const points = [{"t": "公式・正規販売店から買う", "b": "最も確実な対策は、メーカー公式サイトや正規販売店からの購入です。正規品保証・返金保証の対象になります。"}, {"t": "極端に安い出品を疑う", "b": "定価から大きく外れた格安出品は、模倣品や非正規品の可能性があります。販売元を確認しましょう。"}, {"t": "販売元・保証を確認", "b": "販売元の表記、正規品保証、返金保証の有無をチェック。これらが不明確な出品は避けるのが安全です。"}];
  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          <h2 className="text-lg md:text-2xl font-bold text-gray-900 border-l-4 border-[#0ea5e9] pl-3 mb-6">偽物・正規品の選び方3つのポイント</h2>
          {points.map((p, i) => (
