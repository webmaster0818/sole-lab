...
const faqs = [
  {
    ...
    answer:
      "ピットソールに男性用・女性用の区別はありません。XS（21〜22.5cm）・S（23〜24.5cm）・M（25〜26cm）・L（26.5〜27.5cm）・XL（28〜29cm ※ブラック・ピンクのみ）の5サイズ展開で、男女問わず足のサイズに合わせて選べます。男性の場合はMサイズまたはLサイズが該当する方が多いです。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "現在はXLサイズ（28〜29cm対応）が用意されており、28cm以上の方でも使用できます。ただし、XLサイズはブラック・ピンクのカラーのみの展開です（公式サイトにて2026年7月確認）。29cmを超える方は、一般的なアーチサポートインソールの大きいサイズを検討されることをおすすめします。",
  },
  {
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            <p>
              結論から言えば、<strong>ピットソールは男性でも問題なく使用できます</strong>。ピットソールには男性用・女性用の区別はなく、XS〜XLの5サイズ展開で最大29cmまで対応しています（公式サイトにて2026年7月確認）。
            </p>
            <p>
            ...
            <p>
              なお、28cm以上に対応するXLサイズはブラック・ピンクのカラーのみの展開で、29cmを超えるサイズには対応していない点に注意が必要です。日本人男性の平均足サイズは約26cm前後であるため、多くの男性はM（25〜26cm）またはL（26.5〜27.5cm）で対応可能です。
            </p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-100">
                    <td className="py-3 text-gray-900 font-bold">XL</td>
                    <td className="py-3 text-gray-900 font-bold">
                      28〜29cm
                    </td>
                    <td className="py-3 text-gray-500">
                      28cm以上の男性向け（ブラック・ピンクのみ）
                    </td>
                    <td className="py-3 text-gray-900">○</td>
                  </tr>
                </tbody>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              {
                title: "XLサイズはカラーが限定される",
                desc: "ピットソールの最大サイズはXL（28〜29cm）ですが、XLはブラック・ピンクのカラーのみの展開です。29cmを超える男性は残念ながら使用できません。購入前に自分の足のサイズを正確に測定しましょう。靴のサイズではなく、実際の足の長さで確認することをおすすめします。",
              },
              {
              ...
              {
                title: "複数足セットがお得",
                desc: "通勤用・プライベート用など複数の靴で使う場合は、4足セット（1足あたり4,530円）や6足セット（1足あたり4,026円）がコスパに優れます（公式サイトにて2026年7月確認）。毎日入れ替える手間も省けます。特に革靴とスニーカーの両方で使いたい男性には、セット購入をおすすめします。",
              },
            ].map((item) => (
              <div key={item.title} className="card">
                <h3 className="text-base font-bold text-gray-900 mb-2">
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">
            2026年時点で、ピットソールには<strong>XLサイズ（28-29cm）が追加</strong>されています（公式サイトにて2026年7月確認）。これまで足のサイズが27.5cmを超える男性はLサイズでは対応しきれないケースがありましたが、XLサイズの登場により幅広い足サイズに対応可能になりました。なお、XLサイズは<strong>ブラック・ピンクのカラーのみ</strong>の展開である点に注意してください。
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
            ...
            <p>
              M（25〜26cm）とL（26.5〜27.5cm）の2サイズで多くの男性に対応し、28cm以上の方向けにはXL（28〜29cm・ブラック・ピンクのみ）もあります。ビジネスシューズにも装着可能です。ジムに通う時間がない忙しいビジネスマンにとって、日常の歩行をダイエットに変える最も手軽な選択肢の一つでしょう。
            </p>
            <p>
              ただし、29cmを超える足のサイズには対応していないことと、効果を実感するには最低3ヶ月の継続が必要な点は理解しておきましょう。正しいサイズで毎日使い続ければ、姿勢改善・体型変化・健康数値の改善が期待できます。
            </p>
          </div>
