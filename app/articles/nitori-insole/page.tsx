...
const faqs = [{"q": "ニトリにダイエットインソールはありますか？", "a": "ニトリのインソールは日常の快適さ向けが中心で、ダイエット専用設計ではありません。ダイエット目的には専用品が向いています。"}, {"q": "ニトリのインソールは安いですか？", "a": "低価格でコスパが良いのが特徴です。日常の靴を手軽に快適にしたい方に向いています。"}, {"q": "専用品との違いは何ですか？", "a": "目的が異なります。ニトリ品は日常の快適さ重視、ダイエットインソールは姿勢・歩行を整える設計です。"}];
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">一方、ダイエットインソールは足元を安定させ姿勢・歩き方を整える専用設計です。ニトリ品は日常の快適さには向きますが、ボディメイクを狙うなら専用品のほうが目的に合います。</p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">価格も目的も異なるため、自分の目的に合うかで選ぶのがポイントです。</p>
        </section>
