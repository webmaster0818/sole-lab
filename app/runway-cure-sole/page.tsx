...
export const metadata: Metadata = {
  ...
  description:
    "結論、ドン・キホーテや薬局など実店舗での取り扱いは確認されていません。購入は公式サイト（FLOReショップ）が中心で、セット割引は公式限定。販売店の調査結果、最安値の考え方、口コミ・評判、外反母趾の注意点まで検証して解説します。",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "結論、実店舗での取り扱いは確認されていません。公式サイト中心の販売状況と最安値の考え方、口コミ・評判、外反母趾の注意点まで検証。",
...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "ランウェイキュアソールはM（22.5〜23.5cm）とL（24.0〜25.0cm）の女性向けサイズ展開のため、男性にはサイズが合わない場合が多いです。男性にはピットソール（最大29cm対応）がおすすめです。",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "2026年7月時点の確認では、ドン・キホーテなど実店舗での取り扱いは確認できていません。単品6,980円に対し、2足セット11,980円・3足セット17,960円のセット割引が適用されるのは公式サイト限定のため、複数足を検討している場合は公式サイトのセット購入が最も割安です（価格は購入前に公式サイトでご確認ください）。",
      },
    },
    {
      "@type": "Question",
