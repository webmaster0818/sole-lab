...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "知恵袋で「痩せない」「怪しい」という声を見ますが本当ですか？",
      acceptedAnswer: {
        "@type": "Answer",
        text: "知恵袋などのQ&Aサイトでは「履くだけで痩せるのか」という質問が多く見られます。実際、ピットソール単体で体重が落ちる商品ではなく、足裏アーチを補整して正しい姿勢・歩行を促すサポートアイテムです。「履くだけで痩せる」と期待して購入すると「痩せない」という感想になりやすく、ダイエットカフェでの評価が2.7/5にとどまるのもこの期待値のズレが一因です。食事管理や歩行量とあわせて活用するのが現実的な使い方です。",
      },
    },
  ],
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "知恵袋などのQ&Aサイトでは「履くだけで痩せるのか」という質問が多く見られます。実際、ピットソール単体で体重が落ちる商品ではなく、足裏アーチを補整して正しい姿勢・歩行を促すサポートアイテムです。「履くだけで痩せる」と期待して購入すると「痩せない」という感想になりやすく、ダイエットカフェでの評価が2.7/5にとどまるのもこの期待値のズレが一因です。食事管理や歩行量とあわせて活用するのが現実的な使い方です。",
  },
];
