...
export const metadata: Metadata = {
  ...
  title: "診断結果: あなたに合うのはスリムアップインソール｜ダイエットインソール相性診断",
  description:
    "6つの質問によるダイエットインソール相性診断の結果ページです。スリムアップインソール（コスパ重視のダイエットインソール）と相性が良い回答傾向でした。特徴と選ばれる理由を紹介します。",
  alternates: { canonical: "https://sole-laboratory.com/diagnosis/result/slimup/" },
  openGraph: {
    title: "診断結果: あなたに合うのはスリムアップインソール",
    description: "6つの質問でわかるダイエットインソール相性診断（ソールラボ）",
    url: "https://sole-laboratory.com/diagnosis/result/slimup/",
    siteName: "ソールラボ",
    type: "website",
    locale: "ja_JP",
    images: [{ url: "https://sole-laboratory.com/og/diagnosis-slimup.png", width: 1200, height: 630 }],
  },
  twitter: { card: "summary_large_image" },
};

export default function DiagnosisResultPage() {
  const url = "https://sole-laboratory.com/diagnosis/result/slimup/";
  return (
    <main className="py-12 md:py-16">
      <div className="max-w-2xl mx-auto px-4">
        <div className="rounded-2xl border border-[#f3e0e4] bg-white p-6 md:p-10 text-center">
          ...
          <h1 className="mt-1 text-3xl font-bold" style={{ color: "#34d399" }}>スリムアップインソール</h1>
          <p className="mt-1 text-sm text-gray-500">コスパ重視のダイエットインソール</p>
          <p className="mt-5 text-sm text-gray-700 leading-relaxed text-left">試しやすさ・コスパを重視する方に向いた結果です。シンプルな設計のスリムアップインソールは、インソールが初めての方や、まず手頃に始めたい方と相性が良い製品です。</p>
          ...
          <div className="mt-8 border-t border-gray-100 pt-6">
            ...
            <ShareButtons url={url} text="ダイエットインソール相性診断の結果: あなたに合うのはスリムアップインソールでした" />
          </div>
          <div className="mt-6">
